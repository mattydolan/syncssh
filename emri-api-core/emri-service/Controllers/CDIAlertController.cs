...
namespace emri_service.Controllers
{
    ...
    public class CDIAlertController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("alert/{alertid:int}/response")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status201Created)]
        public IActionResult Post(int alertid , CDIAlertResponseDTO alertResponseDTO)
        {
        ...
        [HttpGet]
        [Route("member/{memberid}/alert")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        public IActionResult Get(string memberId, [FromQuery] string providerId = null, [FromQuery] string practiceId = null)
        {
            return Ok();
        }
    }
